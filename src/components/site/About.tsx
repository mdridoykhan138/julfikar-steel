const STATS = [
  { value: "01", label: "Strength", copy: "High tensile grades tested for yield, ductility and load." },
  { value: "02", label: "Precision", copy: "Controlled rolling tolerances held across every batch." },
  { value: "03", label: "Quality", copy: "Documented inspection from billet to finished bundle." },
];

export function About() {
  return (
    <section id="about" className="relative border-t border-[color:var(--border)] py-[clamp(6rem,16vh,12rem)]">
      <div className="shell">
        ...
        <div className="mt-14 grid gap-14 lg:grid-cols-12">
          ...
          <div className="space-y-7 lg:col-span-5">
            <p className="text-lg leading-relaxed text-[color:var(--steel)]" data-reveal>
            ...
            <p className="text-sm leading-relaxed text-[color:var(--steel-dim)]" data-reveal data-reveal-delay="0.1">
        ...
        <div className="mt-[clamp(4rem,10vh,7rem)] grid border-t border-[color:var(--border)] md:grid-cols-3" data-stagger>
          {STATS.map((s) => (
            <div
              key={s.label}
            ...
            >
              ...
              <p className="mt-4 max-w-xs text-sm leading-relaxed text-[color:var(--steel-dim)]">
                {s.copy}
              </p>
            </div>
          ))}
